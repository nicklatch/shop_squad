defmodule ShopSquadWeb.CoreComponents do
  @moduledoc """
  ...
  def table(assigns) do
    ...
    ~H"""
    <div class="px-4 mx-auto sm:overflow-visible sm:px-0 sm:max-w-6xl">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ShopSquadWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ShopSquadWeb.Gettext, "errors", msg, opts)
    end
  end
