defmodule ShopSquadWeb.Router do
  use ShopSquadWeb, :router

  import ShopSquadWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {ShopSquadWeb.Layouts, :root}
  ...
  if Application.compile_env(:shop_squad, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ShopSquadWeb.Telemetry
  ...
  scope "/", ShopSquadWeb do
    ...
    live_session :current_user,
      on_mount: [{ShopSquadWeb.UserAuth, :mount_current_user}] do
